...
imputation_method <- mice(W7R, method = 'pmm', m = 5, maxit = 50, seed = 123)

# Check the imputation
summary(imputation_method)

# Complete the dataset with the imputed values
W7R_complete <- complete(imputation_method)

# Save the imputed dataset
save(W7R_complete, file = "CImputed PMM integral FINALE.rda")